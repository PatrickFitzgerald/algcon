classdef CodeSnippet < handle & matlab.mixin.Heterogeneous % The concatenation methods here are helpful, less so the heterogeneous part
	...
	methods (Access = public)
		...
		function infoNodeDetails = analyze(this,validInfoNodeTypes)
			...
			while ~isempty(row_rows_DOT)
				...
				fieldNames = this.lexer.labels(this.lexer.relations(rows_rightChild,this.lexer.cols.string));
